...
export const siteTitle = "cmd.khulnasoft.com - Find commands at the speed of thought";
export const siteDescription =
  "cmd.khulnasoft.com is a searchable, templated catalog of popular terminal commands curated from across the internet.";
